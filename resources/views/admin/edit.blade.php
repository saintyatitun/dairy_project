                            ...
                            <div class="card-body">
                                ...
                                <form method="POST" action="{{ route('admin.update' , $product->id) }}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" value="{{ $product->name }}" class="form-control" id="exampleFormControlInput1" placeholder="enter product" name ="name" required>
                                    </div>

                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1" class="form-label">Price</label>
                                        <input type="number"  value="{{$product->price}}" id="price" name="price" step="0.01" min="0" placeholder="Enter price" name ="price" required>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" value="{{$product->description}}"  id="exampleFormControlTextarea1" rows="3" name ="description" required></textarea>
                                    </div>
                                    ...
                                    <button class="btn btn-primary my-2 align-items-center" type="submit">Update</button>
                                </form>
